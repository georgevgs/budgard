...
const getEditableKind = (
  ...
  if (category?.kind === 'need') {
    return 'need';
  }
  if (category?.kind === 'want') {
    return 'want';
  }
...
const renderFormTitle = (
  ...
  if (isIncomeCategory && isEditing) {
    return t('income.editSource');
  }
  if (isIncomeCategory) {
...
const renderFormDescription = (
  ...
  if (isIncomeCategory && isEditing) {
    return t('income.editSourceDescription');
  }
  if (isIncomeCategory) {
    return t('income.addSourceDescription');
  }
  if (isEditing) {
    return t('categories.editDescription');
  }
