...
import { getCategoryImpact } from '@/common/components/categories/utils/categoryDeleteImpact';
import type { Category, CategoryType } from '@/types/Category';
import type { Expense } from '@/types/Expense';
import type { CategoryImpact } from '@/common/components/categories/utils/categoryDeleteImpact';
