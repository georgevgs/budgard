...
import { CategoryDeleteDialog } from '@/common/components/categories/CategoryDeleteDialog';
import { useCategoryManager } from '@/common/components/categories/hooks/useCategoryManager';
import { useDataConfig } from '@/common/contexts/DataContext';
import type { Category, CategoryType } from '@/types/Category';
import { CategoryForm } from '@/common/components/categories/CategoryForm';
