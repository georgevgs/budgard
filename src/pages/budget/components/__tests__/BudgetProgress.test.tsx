...
vi.mock('@/pages/budget/components/BudgetForm', () => ({ BudgetForm: ({ isOpen }: { isOpen: boolean }) => {
...
vi.mock('@/pages/budget/components/CategoryBudgetsManager', () => ({ CategoryBudgetsManager: ({ isOpen }: { isOpen: boolean }) => {
    if (!isOpen) return null;
...
vi.mock('@/common/hooks/useCurrentMonthSpendingByCategory', () => ({
