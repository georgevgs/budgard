...
import { computeAccountXirr } from '@/pages/networth/utils/xirr';
...
export const renderInvestmentDetail = (
  ...
  // The KPI strip (cost basis, gain, YTD, XIRR) is investment analytics — Pro
  // depth. Free users are already told exactly this by the upsell card on the
  // Net worth screen they opened this sheet from; repeating it as a padlock
  // here made the same feature nag twice in two taps, so it just stays out.
  if (!isPro) {
    return null;
  }
