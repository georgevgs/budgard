...
const expenses: Expense[] = [
  {
    id: '1', amount: 3.5, description: 'Coffee', date: '2026-01-15',
    category_id: 'cat-1', user_id: 'u1', created_at: '2026-01-15T10:00:00Z',
  },
  {
    id: '2', amount: 25, description: 'Bus pass', date: '2026-01-16',
    category_id: 'cat-2', user_id: 'u1', created_at: '2026-01-16T10:00:00Z',
  },
  {
    id: '3', amount: 100, description: 'No category', date: '2026-01-17',
    category_id: null, user_id: 'u1', created_at: '2026-01-17T10:00:00Z',
  },
];
...
describe('downloadExpensesAsCSV', () => {
  ...
  it('creates a CSV blob and triggers download with correct filename', () => {
    ...
    expect(clickedLink?.getAttribute('download')).toBe('expenses_January_2026.csv');
  });
  ...
  it('generates CSV with correct mime type', () => {
    downloadExpensesAsCSV({ expenses: [expenses[0]], categories, selectedMonth: '2026-01' });
