...
const PaywallHero = () => {
  ...
  return (
    <div className="relative flex flex-col items-center gap-3 text-center">
      ...
      />
      <div className="relative flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-primary/75 text-primary-foreground shadow-lg shadow-primary/30">
