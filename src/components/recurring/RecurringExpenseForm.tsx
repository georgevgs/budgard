...
import {recurringExpenseSchema, type RecurringExpenseFormData} from "@/lib/validations";
    ...
    return (
        <div className="p-6">
            <DialogHeader>
                ...
                <DialogDescription>
                    Set up an expense that will automatically repeat based on the frequency you choose.
                </DialogDescription>
            </DialogHeader>
